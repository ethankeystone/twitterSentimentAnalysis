...
import pandas as pd
import PreProcess
def generateDailyTwitterData(search, amount, path):
    consumer_key = 'P1yqSoexeQAFj5V25HTRsjtM8'
    consumer_secret = 'vQ9Ya25xZ89gQdDmebxuxN3Jga4dhC0evYdP7jBKwxqdWEhQBa'
    access_token = '1119392229263458309-T9mLnN2EhiRudFUPk9NoKHW3XzUZ5P'
    access_token_secret = '5mnZLCrXYtqlac5cQYw96yhDzhjX8MO7rmB3hD5A6Ak0R'
